...
panel1N=load('solarPanel1yield2OffsetPinShellTwNmoN2.out');
panel2N=load('solarPanel2yield2OffsetPinShellTwNmoN2.out');
...
fileout='.\figures\purlinBuckle2offsetPinShellTwNmoN2.';
