...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/DB40EndNoImperf.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of end node
recorder Node -file $dataDir/DB40MidNoImperf.out -time -node $MiddleNode -dof 1 2 3 4 5 6 disp;			# displacements of middle node
