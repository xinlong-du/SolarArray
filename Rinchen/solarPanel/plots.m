...
panel1N=load('solarPanel1yield2OffsetPinTwPmoPdc2.out');
panel2N=load('solarPanel2yield2OffsetPinTwPmoPdc2.out');
...
fileout='.\figures\purlinBuckle2offsetPinTwPmoPdc2.';
