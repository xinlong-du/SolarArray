...
panel1twNmoP=load('solarPanel1yield2OffsetTwNmoP.out');
panel2twNmoP=load('solarPanel2yield2OffsetTwNmoP.out');
panel1twPmoP=load('solarPanel1yield2OffsetTwPmoP.out');
panel2twPmoP=load('solarPanel2yield2OffsetTwPmoP.out');
...
plot(panel1twNmoP(:,5),panel1twNmoP(:,1),'k-')
plot(panel2twNmoP(:,5),panel2twNmoP(:,1),'r--')
...
fileout='.\figures\purlinBuckle2offsetMoP.';
print(hfig,[fileout,'tif'],'-r300','-dtiff');

%% plot for the negative moment case
panel1twNmoN=load('solarPanel1yield2OffsetTwNmoN.out');
panel2twNmoN=load('solarPanel2yield2OffsetTwNmoN.out');
panel1twPmoN=load('solarPanel1yield2OffsetTwPmoN.out');
panel2twPmoN=load('solarPanel2yield2OffsetTwPmoN.out');
...
plot(panel1twNmoN(:,5),panel1twNmoN(:,1),'k-')
plot(panel2twNmoN(:,5),panel2twNmoN(:,1),'r--')
plot(panel1twPmoN(:,5),panel1twPmoN(:,1),'k-')
plot(panel2twPmoN(:,5),panel2twPmoN(:,1),'r--')
...
set(hfig,'PaperUnits','inches');
set(hfig,'PaperPosition',[0 0 figWidth figHeight]);
fileout='.\figures\purlinBuckle2offsetMoN.';
print(hfig,[fileout,'tif'],'-r300','-dtiff');